...
VALUES (1, 7, '<8번 출구> 개봉5주차 주중 현장 증정 이벤트', '2025-11-19', NULL, 5, 'https://comtogether.s3.ap-southeast-2.amazonaws.com/8%EB%B2%88%EC%B6%9C%EA%B5%AC_%EC%A3%BC%EC%A4%91_%EC%9D%B4%EB%B2%A4%ED%8A%B8.jpg');
INSERT INTO events (movie_id, creator_id, title, start_date, end_date, week_no, image)
VALUES (1, 7, '<8번 출구> 개봉5주차 주말 현장 증정 이벤트', '2025-11-22', NULL, 5, 'https://comtogether.s3.ap-southeast-2.amazonaws.com/string/8%EB%B2%88%EC%B6%9C%EA%B5%AC_%EC%A3%BC%EB%A7%90_%EC%9D%B4%EB%B2%A4%ED%8A%B8.jpg');
INSERT INTO events (movie_id, creator_id, title, start_date, end_date, week_no, image)
...
INSERT INTO events (movie_id, creator_id, title, start_date, end_date, week_no, image)
VALUES (4,7,'<극장판 체인소 맨: 레제편> 개봉 9주차 주중 현장 증정 이벤트','2025-11-19',NULL,9,'https://comtogether.s3.ap-southeast-2.amazonaws.com/string/%EC%B2%B4%EC%9D%B8%EC%86%8C%EB%A7%A8_%EC%9D%B4%EB%B2%A4%ED%8A%B8.jpg');
INSERT INTO events (movie_id, creator_id, title, start_date, end_date, week_no, image)
